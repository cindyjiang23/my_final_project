...
name = st.siderbar.text_input('Name')
country = st.siderbar.text_input('Country')
award = st.sidebar.multiselect('Award', ['3 Stars', '2 Stars', '1 Star', 'Bib Gourmand'], default=['3 Stars', '2 Stars', '1 Star', 'Bib Gourmand'])
gdp_per_capita = st.siderbar.slider('GDP per Capita (USD)', 6923, 116906, (6923, 116906))
household_spending = st.siderbar.slider('Household Spending', 12775, 15902575, (12775, 15902575))
